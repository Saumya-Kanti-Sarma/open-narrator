 ...
 * Description: Renders three pricing tiers with features list and CTA buttons
 * Props: none
 */
  ...
  return (
    ...
    >
      <div ref={headingRef} className="reveal text-center mb-16">
        ...
        >
          Currenty we are launching the beta state which has all the features of our pro plan
        </p>
      </div>
        ...
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              <h3
                className="text-xl font-bold text-[var(--bg-light)] mb-1"
                style={{ fontFamily: "var(--font-sans)" }}
              >
                {plan.name}
              </h3>
              ...
              <div className="mb-1">
                <p
                  className={`text-3xl font-bold ${plan.disabled ? "text-[var(--gray-700)]" : styles.price}`}
                  style={{ fontFamily: "var(--font-sans)" }}
                >
                  {plan.price}
                </p>
                <p
                  className="text-xs text-[var(--gray-700)] mt-0.5"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  {plan.priceNote}
                </p>
              ...
              <p
                className="text-sm text-[var(--gray-300)] mb-6 mt-3"
                style={{ fontFamily: "var(--font-body)" }}
              >
                {plan.description}
              </p>
              ...
              <ul className="space-y-3 mb-8 flex-1">
                {plan.features.map((f) => (
                  <li
                    key={f}
                    className="flex items-start gap-2 text-sm text-[var(--gray-300)]"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    <MdCheck
                      size={16}
